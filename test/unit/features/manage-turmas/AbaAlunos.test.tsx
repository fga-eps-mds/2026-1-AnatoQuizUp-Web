...
import { AbaAlunos } from '../../../../src/features/manage-turmas/ui/AbaAlunos';
import {
  desvincularAlunoTurma,
  listarAlunosDaTurma,
  vincularAlunoTurma,
} from '../../../../src/entities/turmas/api/turmaApi';
import { buscarAlunos, buscarUsuariosPorIds } from '../../../../src/entities/usuarios/api/usuarioApi';
import type { UsuarioResumo } from '../../../../src/entities/usuarios/model/types';
import type { VinculoTurmaAluno } from '../../../../src/entities/turmas/model/types';
