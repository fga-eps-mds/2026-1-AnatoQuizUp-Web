...
const loadService = async (useMocks: boolean) => {
  ...
  jest.doMock('../../../../../src/features/register-student/model/mockRegisterStudentService', () => ({
    registerStudentMock,
  }));

  return import('../../../../../src/features/register-student/model/registerStudentService');
};

import type { RegisterStudentFormValues } from '../../../../../src/features/register-student/model/types';
