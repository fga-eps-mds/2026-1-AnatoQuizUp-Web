jest.mock('../../../../../src/features/register-student/model/registerStudentService', () => {
...
jest.mock('../../../../../src/shared/api/localidadesService', () => ({
  listarEstados: jest.fn(),
  listarCidadesPorUf: jest.fn(),
}));

jest.mock('../../../../../src/shared/api/opcoesAcademicasService', () => ({
  listarOpcoesAcademicas: jest.fn(),
}));

jest.mock('../../../../../src/shared/api/nacionalidadesService', () => ({
...
import { listarCidadesPorUf, listarEstados } from '../../../../../src/shared/api/localidadesService';
import { listarNacionalidades } from '../../../../../src/shared/api/nacionalidadesService';
import { listarOpcoesAcademicas } from '../../../../../src/shared/api/opcoesAcademicasService';
import { ESTADOS_BRASIL } from '../../../../../src/shared/constants/estados';
import {
  RegisterStudentError,
  registerStudent,
  validateRegisterStudentIdentity,
} from '../../../../../src/features/register-student/model/registerStudentService';
import { RegisterStudentForm } from '../../../../../src/features/register-student/ui/RegisterStudentForm';
