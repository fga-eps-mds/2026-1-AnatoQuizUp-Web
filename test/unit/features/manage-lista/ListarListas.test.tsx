...
import { ListarListas } from '../../../../src/features/manage-lista/ListarListas';
...
jest.mock('../../../../src/shared/config/env', () => ({ API_BASE_URL: 'http://localhost:4000/api/v1', USE_MOCKS: false }));

jest.mock('../../../../src/features/manage-lista/ModalLista', () => ({
...
jest.mock('../../../../src/features/manage-lista/ModalGerenciarQuestoesLista', () => ({
...
jest.mock('../../../../src/features/manage-lista/ModalExcluirLista', () => ({
