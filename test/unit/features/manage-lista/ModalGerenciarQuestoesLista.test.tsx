...
import { ModalGerenciarQuestoesLista } from '../../../../src/features/manage-lista/ModalGerenciarQuestoesLista';

import * as listaApi from '../../../../src/entities/lista/api/listaApi';
import * as questionService from '../../../../src/features/manage-questions/model/questionService';
import type { ListaQuestao } from '../../../../src/entities/lista/model/types';
import type { ProfessorQuestion } from '../../../../src/features/manage-questions/model/types';
...
jest.mock('../../../../src/shared/config/env', () => ({ apiBaseUrlFromEnv: 'http://localhost:3000', env: { VITE_API_URL: 'http://localhost:3000' } }));
