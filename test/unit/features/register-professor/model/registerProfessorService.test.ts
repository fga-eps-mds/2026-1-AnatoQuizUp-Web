...
const loadService = async (useMocks: boolean) => {
  ...
  jest.doMock('../../../../../src/features/register-professor/model/mockRegisterProfessorService', () => ({
    registerProfessorMock,
  }));

  return import('../../../../../src/features/register-professor/model/registerProfessorService');
};

import { PROFESSOR_INSTITUTION, type RegisterProfessorFormValues } from '../../../../../src/features/register-professor/model/types';
