  ...
  if (loading) {
    return (
      <div className="flex h-screen items-center justify-center bg-gray-50">
        <div className="text-xl font-bold text-[#00214d] animate-pulse">Carregando seu progresso...</div>
      </div>
    );
  }
  ...
  if (!data || data.totalRespondidas === 0) {
    return (
      <div className="flex h-full min-h-[80vh] flex-col items-center justify-center p-6 text-center">
        ...
        <h2 className="mb-2 text-2xl font-bold text-[#00214d]">Nenhuma questão respondida ainda!</h2>
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        {/* --- Distribuição por Tema (Gráfico de Rosca CSS) --- */}
        <div className="rounded-xl bg-white p-6 shadow-sm border border-gray-100 flex flex-col">
          ...
          <div className="flex-1 flex flex-col md:flex-row items-center justify-center gap-8">
            {/* O Gráfico de Rosca (Conic Gradient) */}
        ...
        {/* --- Desempenho por Tema (Barras Estilo Professor) --- */}
